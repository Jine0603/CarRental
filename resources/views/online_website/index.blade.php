                                ...
                                <div class="container">
                                    <div class="row gx-5 align-items-center">
                                        <div class="col-lg-6 offset-lg-3 text-center mb-sm-30">
                                            ...
                                            <p class="lead wow fadeInUp" data-wow-delay=".3s">Creating unforgettable moments and exceeding your every expectation.</p>
                                            <div class="spacer-10"></div>
                                            <a class="btn-line mb10 wow fadeInUp" data-wow-delay=".6s" href="#">Discover</a>
                                        </div>
                                    </div>
                                ...
                                <div class="container">
                                    <div class="row gx-5 align-items-center">
                                        <div class="col-lg-6 offset-lg-3 text-center mb-sm-30">
                                            ...
                                            <p class="lead wow fadeInUp" data-wow-delay=".3s">Our experienced drivers are ready to accompany your journey.</p>
                                            <div class="spacer-10"></div>
                                            <a class="btn-line mb10 wow fadeInUp" data-wow-delay=".6s" href="#">Discover</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-info">
                                        <div class="d-text">
                                            ...
                                            <div class="d-price">
                                                ...
                                                <a class="btn-main" href="{{ route('cars_info.carinfo')}}">Rent Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
